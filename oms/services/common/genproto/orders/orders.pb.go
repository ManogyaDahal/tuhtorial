...
const file_orders_proto_rawDesc = "" +
	...
	"\x06orders\x18\x01 \x03(\v2\r.orders.OrderR\x06orders2\x9a\x01\n" +
	"\fOrderService\x12H\n" +
	"\vCreateOrder\x12\x1a.orders.CreateOrderRequest\x1a\x1b.orders.CreateOrderResponse\"\x00\x12@\n" +
	"\tGetOrders\x12\x17.orders.GetOrderRequest\x1a\x18.orders.GetOrderResponse\"\x00B Z\x1eManogyaDahal/oms/common/ordersb\x06proto3"
...
var file_orders_proto_depIdxs = []int32{
	...
	3, // 2: orders.OrderService.GetOrders:input_type -> orders.GetOrderRequest
