...
func (x *FibonacciResponse) GetNum() int32 {
	if x != nil {
		return x.Num
	}
	return 0
...
const file_main_proto_rawDesc = "" +
	...
	"\x11FibonacciResponse\x12\x10\n" +
	"\x03Num\x18\x01 \x01(\x05R\x03Num2\x9a\x01\n" +
	"\tFibonacci\x12J\n" +
	"\x11GenerateFibonacci\x12\x18.mainpb.FibonacciRequest\x1a\x19.mainpb.FibonacciResponse0\x01\x12A\n" +
	"\vSendNumbers\x12\x15.mainpb.NumberRequest\x1a\x19.mainpb.FibonacciResponse(\x01B\x13Z\x11./proto/gen;genpbb\x06proto3"
...
var file_main_proto_depIdxs = []int32{
	2, // 0: mainpb.Fibonacci.GenerateFibonacci:input_type -> mainpb.FibonacciRequest
	0, // 1: mainpb.Fibonacci.SendNumbers:input_type -> mainpb.NumberRequest
	3, // 2: mainpb.Fibonacci.GenerateFibonacci:output_type -> mainpb.FibonacciResponse
	3, // 3: mainpb.Fibonacci.SendNumbers:output_type -> mainpb.FibonacciResponse
